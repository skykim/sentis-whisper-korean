...
public class WhisperModel : MonoBehaviour
{
    ...
    [SerializeField] private TMP_Text outputTextWindow;
    ...
    private IEnumerator WhisperCoroutine(Action<string> onWhisperCompleted)
    {
        while (_transcribe && _currentToken < _outputTokens.Length - 1)
        {
            ...
            var tokensPredictionsTensorCopy = tokensPredictions.ReadbackAndClone();

            int ID = tokensPredictionsTensorCopy[_currentToken];
            ...
            if (ID == END_OF_TEXT)
            {
                ...
                outputTextWindow.text = _outputString;
    ...
    public void StartRecording()
    {
        ...
        outputTextWindow.text = "Recording started.";
    ...
    public void StopRecording()
    {
        ...
        {
            outputTextWindow.text = "No audio clip recorded.";
            Debug.LogWarning("No audio clip recorded.");
        }

        outputTextWindow.text = "Recording stopped.";
    ...
    void LoadAudio()
    {
        ...
        {
            outputTextWindow.text = $"The audio clip should have frequency 16kHz. It has frequency {_audioClip.frequency / 1000f}kHz"; 
        ...
        {
            outputTextWindow.text = $"The AudioClip is too long. It must be less than 30 seconds. This clip is {_numSamples/ _audioClip.frequency} seconds.";
